...
# This script creates sanity-testing/internal folder containing the copied over scripts from fdk-dotnet/internal/build-scripts folder
...
cp -R .bitbucket/internal/build-scripts/build_nuget_pkg.sh sanity-testing/internal/build-scripts/build_dist_pkg.sh
cp -R .bitbucket/internal/release/sanity_testing.sh sanity-testing/internal/release/sanity_testing.sh
cp -R .bitbucket/internal/docker-files/Dockerfile_build sanity-testing/internal/docker-files/Dockerfile_build
cp -R .bitbucket/internal/docker-files/Dockerfile_unit_test sanity-testing/internal/docker-files/Dockerfile_unit_test